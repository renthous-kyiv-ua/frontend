...
const HouseReg = () => {
  ...
  const handleFileUpload = (e, type, index) => {
    ...
    const maxSize = type === 'photo' ? 4 * 1024 * 1024 : 50 * 1024 * 1024; // 4 MB for photo, 50 MB for video
    if (file.size > maxSize) {
      alert(`Размер ${type === 'photo' ? 'фото' : 'видео'} не должен превышать ${type === 'photo' ? '4' : '50'} MB`);
      return;
    }

    // Предварительный просмотр для фото
    if (type === 'photo') {
    ...
    <div className="house-reg-page">
        ...
        <div className="additional-filling">
          <div className="class-home">
            ...
            <div className="button-group">
              <button className="class-button">Luxury</button>
              <button className="class-button">Comfort</button>
              <button className="class-button">Standart</button>
            </div>
          </div>
          <div className="class-rooms">
            ...
            <div className="button-group">
              {[...Array(6).keys()].map((room) => (
                <button className="room-button" key={room}>{room + 1}</button>
              ))}
          ...
          <div className="class-walls">
            ...
            <div className="button-group walls">
              <button className="wall-button">Ceramic brick</button>
              <button className="wall-button">Ceramic hollow brick</button>
              <button className="wall-button">Ceramic block</button>
              <button className="wall-button">Sand-lime brick</button>
              <button className="wall-button">Foam block</button>
              <button className="wall-button">Reinforced concrete panel</button>
            </div>
          ...
          <div className="class-heating">
            <label>Heating</label>
            <div className="button-group">
              <button className="heating-button">Centralized</button>
              <button className="heating-button">Individual</button>
              <button className="heating-button">Combined</button>
            </div>
          </div>
      ...
      <section className='posting-ad'>
        ...
        <div className='home-describe'>
          ...
          <textarea placeholder='Please describe the object in as much detail as possible.'></textarea>
        </div>
